    ...
    private void changeUser() {
        ...
        if (selectSystem.equals(StartActivity.NEWSYSTEM)) {
            ...
            if (currenSystem.equals(StartActivity.NEWSYSTEM)) {
                user.setText(sp.getString(StartActivity.USERNAME, StartActivity.USERNAME));
                psw.setText(sp.getString(StartActivity.PASSWORD, StartActivity.PASSWORD));
            }
            AlertDialog alertDialog = new AlertDialog.Builder(MenuActivity.this).setTitle("修改用户信息")
                    ...
                    .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialogInterface, int i) {
                            ...
                            editor.putString(StartActivity.USERNAME, user.getText().toString());
                            editor.putString(StartActivity.PASSWORD, psw.getText().toString());
                            editor.commit();
                            userTextView.setText(user.getText().toString());
                        }
                    })
                    .show();
